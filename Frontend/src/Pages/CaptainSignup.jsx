    ...
    <div className="p-7 h-screen flex flex-col justify-between">
      ...
      <div>
        <p className="text-[12px] text-[#181818e6]">
          This site is protected by <span className="underline">re-Captcha</span> and the <span className="underline">Google Privacy Policy</span> & <span className="underline">Terms of Service Apply</span>
        </p>
      </div>
    </div>
  );
